<template>
    <div class="min-h-full">
        <nav class="bg-gray-800">
            <div class="mx-auto max-w-8xl px-4 sm:px-4 lg:px-6">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="w-[60px] h-[46px]" src="../img/Vector2.png" alt="Your Company">
                        </div>
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                                <Link :href="route('guest.index')"
                                      :class="$page.component==='Visitors/DujonibaV' || $page.component==='Visitors/CardD' ? 'bg-gray-900' : ''"
                                      class="text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">
                                    Дуҷониба
                                </Link>
                                <Link :href="route('bg.index')"
                                      :class="$page.component==='Visitors/BisyorjonibaV' || $page.component==='Visitors/CardB' ? 'bg-gray-900' : ''"
                        ...
                        <div class="ml-4 flex items-center md:ml-6 px-4">
                           ...
                           <!-- Profile dropdown -->
                            <div class="relative ml-3">
                                ...
                                <div
                                    v-show="profile"
                                    class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none hover:bg-gray-200 hover:text-blue-700" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
