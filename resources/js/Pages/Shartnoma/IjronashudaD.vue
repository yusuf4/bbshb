<template>
    ...
    <div class="main-content">
        <div class="flex justify-between items-center mb-2">
            <div class="inline-flex rounded-md shadow-sm pl-2 pt-2" role="group">
                <Link
                    ...
                    :class="$page.component==='Shartnoma/IjronashudaD' && 'text-green-600'"
        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
            <tr
                v-for="item in ijronashudaD.data"
                :key="item.id"
        ...
        <div class="flex justify-center my-4">
            <Component
                ...
                v-for="link in ijronashudaD.links"
                :href="link.url"
                v-html="link.label"
...
export default {
    ...
    watch:{
        search(value){
            Inertia.get('/ijronashudaD', {search: value}, {
                preserveState: true
            });
        },
    }
