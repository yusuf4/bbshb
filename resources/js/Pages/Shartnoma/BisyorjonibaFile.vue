    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="flex justify-between mr-0.5 pb-4">
            <div class="inline-flex rounded-md shadow-sm pl-2 pt-2" role="group">
                ...
                <Link
                    ...
                    :class="$page.component==='Shartnoma/BisyorjonibaFile' ? 'text-green-600' : ''"
        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tr
                ...
                >
                    <div
                        v-for="file in item.fileshartnoma_b"
                        :key="file.id"
...
export default {
    ...
    watch:{
        search(value){
            Inertia.get('/filesB', {search: value}, {
                preserveState: true
            });
        }
    }
