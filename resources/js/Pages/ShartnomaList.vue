        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tr>
                <th scope="col" class="p-4">
                    <div class="flex items-center">
                        <input id="checkbox-one-search" disabled type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-50 border-gray-100 rounded focus:ring-blue-500  focus:ring-2">
            ...
            <tr
                ...
                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <a href="uploads/shartnoma/{{file.file_shartnoma.name}}" target="_blank">
                        {{file.name}}
                    </a>
