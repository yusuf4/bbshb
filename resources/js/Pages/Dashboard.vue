            ...
            <div class="flex flex-col justify-between h-full px-[20px] space-y-[10px] ">
                <div class=" flex flex-col justify-between space-y-[10px]">
                    <div class="inline-flex relative items-center py-[10px] px-[10px] w-full text-sm font-medium rounded-md border-gray-200 hover:bg-gray-200 hover:text-blue-800  transition duration-400 ease-in-out">
                        <Link href="/dash" class="flex justify-center  ">
                            <svg
                                ...
                                <path
                                    fill-rule="evenodd"
                                    d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 0010 16a5.986 5.986 0 004.546-2.084A5 5 0 0010 11z" clip-rule="evenodd"></path>
                            </svg>
                            Home
                        </Link>
                    </div>
                    ...
                    <div class="inline-flex relative items-center px-2 py-2 w-full text-sm font-medium rounded-md border-gray-200 hover:bg-gray-200 hover:text-blue-800  transition duration-400 ease-in-out">
                        <a href="#" class="flex cursor-default">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5"
                                stroke="currentColor"
                                class="w-[20px] h-[20px] mr-2 opacity-100">
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                    ...
                    <a href="#" class="flex cursor-copy">
                        <svg
                            ...
                            strokeWidth={1.5}
                            stroke="currentColor"
                            class="mr-2 w-[20px] h-[20px] opacity-100">
                            <path
                                strokeLinecap="round"
                                strokeLinejoin="round"
